...
<nav class="side-menu">
    <ul class="side-menu-list">
        ...
        <li class="aquamarine with-sub">
            ...
            <ul>
                <a href="..\DocsPersonales\listarDocsPersonales.php"><span class="lbl">Articulos Científicos</span></a></li>
                <a href="bootstrap-datatables.html"><span class="lbl">Colaboraciones</span></a></li>
            </ul>
        </li>
        <li class="coral">
