<div class="form-group" id="documentos_requeridos">
    ...
    <div class="row" style="margin-left:25px;">
        ...
        $tiposDocumentos = Certificacion::get_docsrequeridos_x_tramite(7);
        $cantidad_actual = 0;
                    ...
                    <div class="row" style="width:80%;">
                        <div class="form-group agregarMultimedia">
                            <b style="font-size:18px;color:#1e4568;">
                                <?php echo $value["tipo_documento"] ?> <button class="verifyButton" style="padding: 0;border: none;background: none; color:#3faab9" type="button">
