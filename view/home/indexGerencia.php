							...
							<a href="indexCurriculumVirtual.php">
								<article class="statistic-box green">
									<div>
										...
										<div class="caption"><div>Total trámites en el sistema</div></div>
									</div>
								</article>
  							</a>
	                    </div>
							...
							<div class="col-sm-4">
								<article class="statistic-box yellow">
									<div>
										...
										<div class="caption"><div>Cantidad usuarios en el sistema</div></div>
									</div>
								</article>
							</div>
  						</a>
						<a href="../Reposos/listarReposos.php">
							<div class="col-sm-4">
								<article class="statistic-box red">
									<div>
										<div class="number" id="lbltotalrepososvisados"></div>
										<div class="caption"><div>Reposos visados por el sistema</div></div>
									</div>
								</article>
							</div>
  						</a>
