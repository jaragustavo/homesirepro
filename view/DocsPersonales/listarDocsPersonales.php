						...
						<div class="col-lg-6"></div>
							<div class="col-lg-6">
								<fieldset class="form-group">
									...
									<a href= "nuevoDocsPersonales.php"><button class="btn btn-rounded btn-primary btn-block" id="btnfiltrar">Nuevo Documento</button></a>
								</fieldset>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<fieldset class="form-group">
							...
							<input type="date" placeholder="DD-MM-YYYY" class="form-control" id="fecha" name="fecha" required>
