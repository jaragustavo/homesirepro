...
<section class="box-typical steps-icon-block" id="formulario">
    ...
    <div id="parte_3" class="row parte_3">
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <select class="form-control " id="ciudad_residencia" name="ciudad_residencia"onchange="cargarBarrios()"
                        data-placeholder="Seleccionar">
                        <option label="Seleccionar"></option>
                    </select>
                </div>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    <label for="telefono_residencia" style="text-align:left;margin:5px;margin-left:30px;">Teléfono</label>
                    <input type="text" class="form-control" id="telefono_residencia" name="telefono_residencia" placeholder="Telefono"
                        value="<?php echo $_SESSION["telefono"] ?>" />
                </div>
            </div>
            <div class="col-xl-6">
                <div class="form-group">
                    <label for="celular_principal_residencia" style="text-align:left;margin:5px;margin-left:30px;">Celular</label>
                    <input type="text" class="form-control" id="celular_principal_residencia" name="celular_principal_residencia" placeholder="Celular" />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    <label for="celular_secundario_residencia" style="text-align:left;margin:5px;margin-left:30px;">Celular</label>
                    <input type="text" class="form-control" id="celular_secundario_residencia" name="celular_secundario_residencia" placeholder="Celular" />
                </div>
            </div>
            <div class="col-xl-6">
                <div class="form-group">
                    <label for="email_residencia" style="text-align:left;margin:5px;margin-left:30px;">Email</label>
                    <input type="text" class="form-control" id="email_residencia" name="email_residencia" placeholder="E-mail"
    ...
    <div id="parte_4" class="row parte_4">
        ...
        <div class="row">
            <div class="col-xl-6">
                ...
                <input type="text" class="form-control" id="servicio_publico" name="servicio_publico" placeholder="Servicio" />
            </div>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="telefono_publico" name="telefono_publico" placeholder="Telefono"
                        value="<?php echo $_SESSION["telefono"] ?>" />
                </div>
            </div>
            <div class="col-xl-6">
        ...
        <div class="row">
            <div class="col-xl-6">
                ...
                <input type="text" class="form-control" id="servicio_privado" name="servicio_privado" placeholder="Servicio" />
            </div>
            <div class="col-xl-6">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="telefono_privado" name="telefono_privado" placeholder="Telefono"
                        value="<?php echo $_SESSION["telefono"] ?>" />
                </div>
            </div>
            <div class="col-xl-6">
    ...
    <div id="parte_5" class="row parte_5">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="form-group">
                    <label for="pais_titulo" style="text-align:left;margin:5px;margin-left:30px;">País</label>
