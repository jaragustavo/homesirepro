					...
					<section class="box-typical proj-page">
						...
						<section class="proj-page-section">
							<ul class="proj-page-actions-list">
								<li onclick="guardarDocsTramites(7)"><a><i class="font-icon font-icon-archive"></i>Guardar borrador</a></li>
								<li onclick="enviarSolicitud(6)"><a><i class="font-icon font-icon-check-square"></i>Enviar solicitud</a></li>
