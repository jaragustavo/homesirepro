					...
					<section class="box-typical proj-page">
						...
						<section class="proj-page-section">
							<ul class="proj-page-actions-list">
								<li id="guardarDocs" onclick="guardarDocsTramites(7)"><a><i class="font-icon font-icon-archive"></i>Guardar borrador</a></li>
								<li id="enviarSolicitud" onclick="enviarSolicitud(6)"><a href="#"><i class="font-icon font-icon-check-square"></i>Enviar solicitud</a></li>
