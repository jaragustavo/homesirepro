...
$publicaciones = Publicacion::get_publicaciones();
            ...
            <div class="user-card-row">
                <div class="tbl-row">
                    <div class="tbl-cell tbl-cell-photo">
                        <a href="#">
                            <img src="https://sirepro.mspbs.gov.py/foto/<?php echo $value["publicante_ci"] ?>.jpg" alt="">
                        </a>
                    </div>
                    <div class="tbl-cell">
                        <div class="user-card-row-name"><a href="../Publicaciones/perfilUsuario.php?ID=<?php echo $value["publicante_id"] ?>">
                                <?php echo $value["publicante"] ?>
                            </a></div>
                    ...
                    <div class="comment-rows-container hover-action scrollable-block">
                        <div class="comment-row-item">
                            <div class="avatar-preview avatar-preview-32">
                                <a href="#">
                                    <!-- Foto comentario -->
                                    <img src="https://sirepro.mspbs.gov.py/foto/<?php echo $comentario["ci_usuario_comentario"] ?>.jpg" alt="">
                                </a>
                            </div>
            ...
            <div class="tbl">
                <div class="tbl-row">
                    <div class="tbl-cell tbl-cell-action">
                        ...
                        onclick="enviarComentario(<?php echo $value['publicacion_id'] ?>)">Enviar</button>
                    </div>
                </div>
            </div>
        </div>
