...
$publicaciones = Publicacion::get_publicaciones_x_usuario($_SESSION["usuario_id"]);
foreach ($publicaciones as $key => $value) {
    ...
    <article class="box-typical profile-post" id="publicacion<?php echo $value['publicacion_id'] ?>">
