                                            ...
                                            <div class="tbl-row">
                                                ...
                                                <div class="tbl-cell tbl-cell-stat">
                                                    <div class="inline-block">
                                                        <p class="title">
                                                            <?php echo $cantidades_perfil["total_seguidores"] ?></p>
                                                        <p>Seguidores</p>
                                                    </div>
                                                </div>
                                                <div class="tbl-cell tbl-cell-stat">
                                                ...
                                                <div class="tbl-cell tbl-cell-stat">
                                                    <div class="inline-block">
                                                        <p class="title">
                                                            <?php echo $cantidades_perfil["total_publicaciones"] ?></p>
                                                        <p>Publicaciones</p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <aside class="profile-side">
                            <section class="box-typical profile-side-user">
                                <button type="button" class="avatar-preview avatar-preview-128">
                                    <img src="https://sirepro.mspbs.gov.py/foto/<?php echo $_SESSION["cedula"] ?>.jpg"
                                        alt="" />
                                    <span class="update">
                                        <i class="font-icon font-icon-picture-double"></i>
                                        Cambiar foto
                            ...
                            <section class="box-typical">
                                <header class="box-typical-header-sm bordered">Trámites en línea</header>
                                <div class="box-typical-inner">
                                    <div class="progress-compact-style">
                                        <div class="progress-header">
                                            <div class="progress-lbl">Renovación de Registro</div>
                                            <div class="progress-val">10%</div>
                                        </div>
                                        <progress class="progress progress-aquamarine" value="10" max="100">750%</progress>
                                    </div>
