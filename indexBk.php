                                        ...
                                        <div class="mt-6">
                                            <form action="" method="post" id="login_form">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="ci" id="ci" placeholder="Ingrese su cédula">
                                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Desarrollo HomeSirepro
                            </p>
                        </div>
                    </div>
                </div>
